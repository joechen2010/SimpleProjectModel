...
public class LocalDataModel extends PagedListDataModel{
	...
	public LocalDataModel(DAO dao, int pageSize, String sortColumn, boolean ascSorting) {
        super(pageSize);
        this.dao = dao;
    ...
    private DataPage getDataPage(int startRow, int pageSize) {
        ...
        int totalNumberCustomers = dao.getDataCount();
        ...
        List pageCustomers = dao.findPage(sortColumn, ascSorting, startRow, endIndex - startRow);
